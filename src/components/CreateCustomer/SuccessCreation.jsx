...
function SuccessCreation({showModal, handleCloseModal, riderId, first_name, last_name, phone}) {
        ...
        <div className="header text-center">
                ...
                <div className='text-center pb-5 fw-bold text-dark'>
                    ...
                    <div className='mt-5 mb-5'>
                        ...
                        <div>
                        <Link to="/" className='rounded-pill go-back py-2 px-5 text-decoration-none d-block  w-100 btn-link mt-3 text-light'>Edit</Link>
                        </div>
                        <div>
